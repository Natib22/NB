...
{       int choice;
        ...
        string search;
        string name;
        string medicinelist[20]={"Amoxicillin","Ampicillin","Delafloxacin","Paracetamol","Ibuprofen",
                             "Naproxin","Morphine","Potassium","Ascorbic-Acid","Thiamine",
                             "Vitamin-D3","Anthistamine","Decognizant","Sertraline","Fluoxetine"};
         string medicinetype[20]={"Antibiotics","Antibiotics","Antibiotics","Anti-pain","Anti-pain",
                             "Anti-pain","Anti-pain","Vitamins","Vitamins","Vitamins",
                             "Vitamins","Antitussives","Antitussives","Antidepressants", "Antidepressants"};
        int medicineprice[20]={150,180,300,127,120,600,150,90,100,220,400,300,320,230,120};
    ...
    cout<<"4. Place in new medicine order\n";
